...
// let web3 = new Web3(new Web3.providers.HttpProvider("https://mainnet.infura.io/v3/25e722f188b141edbc18f6a3172e4b10"));
...
module.exports = {
    ...
    vipCoinMysql,
    redis,
    genesisGodSDAmount: 100000, //成为创世大神所需要的BIUT
    ...
    teamIncomeTime: '00 20 21 * * *', //每天计算团队收益的时刻
    ...
    tideDecimalDigit: 18, //USDT代币小数位数，18位测试代币roadly小数位数
